 ...
 * Created at 2024. 4. 30. 오후 10:16:13
 */
...
const App = () => {
	...
	return (
		<Moaui.Panel variant='box' relative width={640} height={640}>
			<Moaui.FloatingBox {...{x: 0,y: 0,width: 336,height: 256,guideBoxProps: {"width":"inherit","height":"inherit","center":true,"spacing":2},}}>
			...
			<Moaui.FloatingBox {...{x: 336,y: 0,width: 304,height: 256,guideBoxProps: {"width":"inherit","height":"inherit","center":true,"spacing":2},}}>
				...
				<Moaui.Button {...{id: 'button_delete',disabled: false,width: '100px',loading: false,variant: 'contained',color: 'negative',}}>DELETE</Moaui.Button>
				<Moaui.Button {...{id: 'button_get',disabled: false,width: '100px',loading: false,variant: 'contained',color: 'normal',}}>GET</Moaui.Button>
			</Moaui.FloatingBox>
			<Moaui.FloatingBox {...{x: 0,y: 256,width: 640,height: 384,guideBoxProps: {"width":"inherit","height":"inherit"},}}>
				<Moaui.CodeBlock {...{id: 'print_get',title: 'PRINT GET',radius: 4,width: '100%',backgroundColor: 'black',titlePadding: 1,titlePaddingX: 1,titlePaddingY: 1,codePadding: 1,codePaddingX: 1,codePaddingY: 1,language: 'json',}}>{nodeValue}</Moaui.CodeBlock>
			</Moaui.FloatingBox>
		</Moaui.Panel>
	);
}
